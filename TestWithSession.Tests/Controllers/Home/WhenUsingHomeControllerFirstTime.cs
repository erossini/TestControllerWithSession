...
{
    [TestClass]
    public class WhenUsingHomeControllerFirstTime : WhenUsingHomeController
    {
        [TestMethod]
        public void Then_Url_Must_Be_Default_Value_NoClientId()
        {
            string clientId = "TestId";
            mockSession = new MockHttpSession();
            mockSession.SetString("ClientId", clientId);
            ...
            Assert.AreEqual(clientId, model.ClientId);
        }
    }
}
